...
For supported external APIs, preserve the published compatibility contract or use an explicitly agreed migration. This rule targets internal caller migrations.
