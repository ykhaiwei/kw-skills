...
**Pattern:**
- **Isolate large payloads.** Use targeted extraction first; delegate large independent reads when available and permitted by [runtime](../runtime.md). The main context gets summaries, not raw data.
