...
Place validation, type narrowing, and error handling at system boundaries. Trust established internal invariants. Mutable, cross-process, persisted, or otherwise untrusted data still crosses a boundary. Business logic lives in pure functions. The shell is thin and mechanical.
