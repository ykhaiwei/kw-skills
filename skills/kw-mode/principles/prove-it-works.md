...
Keep the artifact visible for the human. When committing is authorized, include it for large or complex work where the trail has to be auditable later, like a big port or migration ([show your work](../workflows/show-me-your-work.md)).
